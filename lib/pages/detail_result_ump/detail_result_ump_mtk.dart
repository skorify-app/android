...
class DetailResultUmpMtk extends StatefulWidget {
  const DetailResultUmpMtk({super.key});

  @override
  State<DetailResultUmpMtk> createState() => DetailResultUmpMtkState();
}

class DetailResultUmpMtkState extends State<DetailResultUmpMtk> {
