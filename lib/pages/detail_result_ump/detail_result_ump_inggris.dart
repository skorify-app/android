...
class DetailResultUmpInggris extends StatefulWidget {
  const DetailResultUmpInggris({super.key});

  @override
  State<DetailResultUmpInggris> createState() => DetailResultUmpInggrisState();
}

class DetailResultUmpInggrisState extends State<DetailResultUmpInggris> {
